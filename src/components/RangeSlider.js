...
const RangeSlider = ({ initialMin, initialMax, min, max, step, priceCap }) => {
  ...
  return (
    <div className="min-h-screen grid place-items-center bg-block h-24">
      <div className="flex flex-col w-96 bg-white shadow-xl rounded-xl px-6 py-4">
        <p className="font-semibold text-lg text-gray-700 text-center">
          Use slider or enter min and max 
        </p>
        ...
        <div className="mb-4">
          <div className="slider relative h-1 rounded-md bg-gray-300">
            <div
              className="progress absolute h-1 bg-green-500 rounded "
              ref={progressRef}
            ></div>
          </div>
